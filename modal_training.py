...
def generate_datasets():
    ...
    from generate_dataset import NoOrangeDatasetGenerator
    ...
    train_data = generator.generate_comprehensive_dataset(total_samples=8000)
    
    print("🔄 Generating validation dataset...")  
    val_data = generator.generate_comprehensive_dataset(total_samples=1500)
    
    print("🔄 Generating test dataset...")
    test_data = generator.generate_comprehensive_dataset(total_samples=1000)
